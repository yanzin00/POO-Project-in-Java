...
public class TelaCadastroProduto implements ActionListener {
    ...
    public TelaCadastroProduto(ControleDados dados, int op, int pos, int index){
        this.dados = dados;
        this.pos = pos;
        this.index = index;
    ...
    public void actionPerformed(ActionEvent e) {
		...
		if(src == salvarMed) {
			...
			if (jtfNome.getText().equals("") || jtfQtd.getText().equals("")
                ...
                dados.cadastrarEditarCosmetico(nome,quantidade,preco,validade,codigo,volume,marca,pos,index);
